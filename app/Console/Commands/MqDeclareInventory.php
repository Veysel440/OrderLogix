...
final class MqDeclareInventory extends Command
{
    ...
    public function handle(): int
    {
        ...
        $ch->exchange_declare('inventory.parking.x','fanout',false,true,false);
        ...
        $ch->queue_declare('inventory.parking.q', false, true, false, false, false, new AMQPTable([
            'x-queue-type' => 'quorum',
        ]));
        $ch->queue_bind('inventory.parking.q', 'inventory.parking.x', '');
